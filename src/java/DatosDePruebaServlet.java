 ...
 * @author usuario
 */
public class DatosDePruebaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(tipo.equals("cargar")){
           /* icprov.eliminarImagenesUsuarios();
            icprov.eliminarImagenesServicios();*/
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DatosDePruebaServlet.class.getName()).log(Level.SEVERE, null, ex);
