...
public class InformacionPromocionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(nombrePromocion.equals("SudamÃ©rica-Casas")){
            nombrePromocion = "Sudamérica-Casas";
        }
        ...
        if((Boolean) session.getAttribute("agregarLog") == true){
            iclog.agregarLog(LocalDate.now(), "http://localhost:8080/h4t/pages/verInformacionPromocion.jsp", browser, System.getProperty("os.name"));
        }
        response.sendRedirect("pages/verInformacionPromocion.jsp");
