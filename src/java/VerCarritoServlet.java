...
import Logica.ControladorLogs;
import Logica.IControladorLogs;
...
public class VerCarritoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if((Boolean) session.getAttribute("agregarLog") == true){
            iclog.agregarLog(LocalDate.now(), "http://localhost:8080/h4t/pages/verCarrito.jsp", browser, System.getProperty("os.name"));
        }
        response.sendRedirect("pages/verCarrito.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(VerCarritoServlet.class.getName()).log(Level.SEVERE, null, ex);
